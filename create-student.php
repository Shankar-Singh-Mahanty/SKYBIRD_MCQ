...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $username = sanitizeInput($_POST["student-name"]);
    ...
    if (!empty($errors)) {
        ...
        try {
            if ($stmt->execute()) {
                $_SESSION['message'] = "student $username with email: '$email' & password: '$password' created successfully. These credentials can be used for login.";
            } else {
...
if (isset($_SESSION['form_data'])) {
    $username = $_SESSION['form_data']['student-name'];
    ...
    <main>
        <section id="create-student">
            <div class="heading-container">
                ...
                <h2 class="heading">Create student</h2>
            </div>
            <?php
            ...
            <form class="form_container" action="create-student.php" method="post">
                ...
                <button class="submit-button" type="submit">Create Student</button>
            </form>
        </section>
    </main>
